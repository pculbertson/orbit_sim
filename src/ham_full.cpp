...
MatrixXd J(Matrix3d R, Matrix3d Rd){
	MatrixXd J(6,6);
	J << MatrixXd::Identity(3,3), MatrixXd::Zero(3,3),
		 MatrixXd::Zero(1,3), (R(2,1)*Rd(3,1)-R(3,1)*Rd(2,1)), (R(3,1)*Rd(1,1)-R(1,1)*Rd(3,1)), (R(1,1)*Rd(2,1)-Rd(1,1)*R(2,1)),
		 MatrixXd::Zero(1,3), (R(2,2)*Rd(3,2)-R(3,2)*Rd(2,2)), (R(3,2)*Rd(1,2)-R(1,2)*Rd(3,2)), (R(1,2)*Rd(3,2)-R(2,2)*Rd(1,2)),
		 MatrixXd::Zero(1,3), (R(2,3)*Rd(3,3)-R(3,3)*Rd(2,3)), (R(3,3)*Rd(1,3)-R(1,3)*Rd(3,3)), (R(3,3)*Rd(1,3)-R(1,3)*Rd(3,3));
 	return J;
}

MatrixXd Jdot(Matrix3d R, Matrix3d Rd, Matrix3d R_dot, Matrix3d Rd_dot){
	MatrixXd Jdot(6,6);
	J << MatrixXd::Zero(3,6),
		 MatrixXd::Zero(1,3), (R_dot(2,1)*Rd(3,1)-R_dot(3,1)*Rd(2,1))+(R(2,1)*Rd_dot(3,1)-R(3,1)*Rd_dot(2,1)), (R_dot(3,1)*Rd(1,1)-R_dot(1,1)*Rd(3,1))+(R(3,1)*Rd_dot(1,1)-R(1,1)*Rd_dot(3,1)), (R_dot(1,1)*Rd(2,1)-Rd_dot(1,1)*R(2,1))+(R(1,1)*Rd_dot(2,1)-Rd(1,1)*R_dot(2,1)),
		 MatrixXd::Zero(1,3), (R_dot(2,2)*Rd(3,2)-R_dot(3,2)*Rd(2,2))+(R(2,2)*Rd_dot(3,2)-R(3,2)*Rd_dot(2,2)), (R_dot(3,2)*Rd(1,2)-R_dot(1,2)*Rd(3,2))+(R(3,2)*Rd_dot(1,2)-R(1,2)*Rd_dot(3,2)), (R_dot(1,2)*Rd(3,2)-R_dot(2,2)*Rd(1,2))+(R(1,2)*Rd_dot(3,2)-R(2,2)*Rd_dot(1,2)),
		 MatrixXd::Zero(1,3), (R_dot(2,3)*Rd(3,3)-R_dot(3,3)*Rd(2,3))+(R(2,3)*Rd_dot(3,3)-R(3,3)*Rd_dot(2,3)), (R_dot(3,3)*Rd(1,3)-R_dot(1,3)*Rd(3,3))+(R(3,3)*Rd_dot(1,3)-R(1,3)*Rd_dot(3,3)), (R_dot(3,3)*Rd(1,3)-R_dot(1,3)*Rd(3,3))+(R(3,3)*Rd_dot(1,3)-R(1,3)*Rd_dot(3,3));
	return Jdot; 
}
